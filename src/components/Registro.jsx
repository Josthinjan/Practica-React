...
const Registro = () => {
    ...
    const handleRegistro = (event) => {
        ...
        // Si no hay errores, puedes redirigir o realizar la acción deseada
        if (!errores) {
            alert('Registro exitoso'); // Cambia esto por tu acción de registro exitoso
        }
    };
                    ...
                    <div className="cuerpo-registro">
                        <form action="" className="registrof" id="registrof" onSubmit={handleRegistro}>
                            ...
                            <p className="textoregistro">
                                ¿Ya tienes una cuenta? <a href="inicio-sesion.html"><b>Iniciar Sesión</b></a>
                            </p>
                        </form>
                    </div>
                </main>
